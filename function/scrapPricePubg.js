...
async function scrapHargaPubg() {
    try {
        ...
        await page.goto('https://moogold.com/product/pubg-mobile-indonesia/');
        ...
        fs.writeFileSync('./produk/pubg.json', JSON.stringify(productList, null, 2));
